...
#RpsiFinder will generate a file in output_dir/ and named as output_name.txt (for example: ../test_out/RpsiFinder_out/RpsiFinder_out.txt)
...
ground_truth(RpsiFinder_res_file="../test_out/RpsiFinder_out/test_udfilt.txt",
...
RpsiAnnotator(input_bedfile="../test_out/RpsiFinder_out/test_udfilt.bed",
            annotation_bed6file="../test_data/annotation/hg38.genecode.v30.tRNA.snoRNA.miRNA.rmsk.exonFeatures.bed6",
...
```R
mod_info(RpsiFinder_res_file="../test_out/roc/roc_roc_psi_prediction.bed",
...
mod_info(RpsiFinder_res_file="../test_out/user_defined/user_defined_ud_psi_prediction.bed",
...
mod_info(RpsiFinder_res_file="../test_out/svm_predict/svm_predict_svm_psi_prediction.bed",
